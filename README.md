...
```
Please note that this format is used for Task questions.
- `O(1)`
- `O(n)`
- `O(n!)`
- n square -> `O(n^2)`
...
Write in the file `0-O`, the big O notaations of the time complexity of the Bubble sort algorithm, with 1 notation per line:
- in the best case
- in the average case
- in the worst case
```
...
Write a function that sorts an array of integers in ascending order using the [Quick sort](https://en.wikipedia.org/wiki/Quicksort)
